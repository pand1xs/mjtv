module.exports = {
    ...
    category: "Dates",
    aliases: ["Get Time Info", "Get Timestamp Info", "Timestamp Get", "Date Get", "Current Time", "Current Date"],
    UI: [
      {
    ...
    async run(values, message, client, bridge) {
      ...
      } else if (values.date.type == 'iso') {
        date = new Date(bridge.transf(values.date.value))
      }
