...
module.exports = {
  ...
  init: (values, bridge) => {
    if (values.type == 'Persistent') {
      bridge.interactionHandlers[ComponentTypes.BUTTON][values.customID == 'Custom' ? values.id : `${thisID}`] = { actions: values.actions, interactionStorage: values.storeInteractionAs, storeInteractionAuthorAs: values.storeInteractionAuthorAs }
    }
  },
